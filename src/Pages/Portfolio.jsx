...
const Portfolio = () => {
  ...
  const [transactiontype, setTrasactionType] = useState("All");
  useEffect(() => {
    fetchBalance();
    fetchStockInfo();
      ...
      <div className="grid grid-cols-2 mt-[68px] grid-rows-2 min-h-screen bg-gray-900 gap-4 p-4">
        ...
        <div className="bg-gray-800 p-6 rounded-lg border-2  col-span-2">
          <div className="overflow-y-auto max-h-[50vh]">
            <table className="bg-gradient-to-br from-blue-950 to-black rounded-2xl text-white w-full border-separate border-spacing-0">
              <thead>
              ...
              <tbody>
                {tinfo.length > 0 ? (
                  tinfo.filter((trans) =>transactiontype ==="All" || trans.transaction_type === transactiontype)
                  .map((trans, index) => (
                    <tr
                      key={index}
                    ...
                    >
                      ...
                      <td className="p-3 text-left text-white">
                        {trans.company_name ? trans.company_name : "N/A"}
                      </td>
                      <td className="p-3 text-left text-white">
                        {trans.quantity}
                      </td>
